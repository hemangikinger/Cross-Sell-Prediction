...
```{r}
mod2 <- randomForest(Response ~ Vehicle_Age + Vehicle_Damage, data = TrainSet, importance = TRUE)
mod2

```

```{r}
mod2 <- randomForest(Response ~ Vehicle_Age + Vehicle_Damage, data = TrainSet, ntree = 500, mtry = 2, importance = TRUE)
mod2
