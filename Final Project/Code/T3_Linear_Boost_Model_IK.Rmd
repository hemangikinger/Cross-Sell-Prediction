...
confusionMatrix(naive1.Prediction.Train, df_train$Response)
confusionMatrix(naive1.Prediction.Test, df_test$Response)
...
# unloadPkg("regclass")
# 
# paste0 ("Accuracy of the model is ",round((68451 + 83720)/200639 * 100,2), "%.")
...
train.index=sample(1:n,size=round(n*0.75),replace=FALSE)
