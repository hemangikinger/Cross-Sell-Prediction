---
title: "Insurance Cross-Sell Summary"
...
Observation: Accuracy of the model is 77.01% and Precision is 69.06%. We'll also run ROC/AUC metric to understand the model better.
...
Observation: Accuracy of the model is 84.83% and Precision is 97.18%. We'll also run ROC/AUC metric to understand the model better.
...
Observation: Accuracy of the model is 75.75% and Precision is 83.18%. We'll also run ROC/AUC metric to understand the model better.
...
1. If a customer has vehicle damage it increases the chance of them buying vehicle insurance.
